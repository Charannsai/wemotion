...
export const aiLayerSchema = z.object({
  ...
  kind: z.enum(['text', 'image', 'video', 'shape']).describe('Type of media layer'),
  ...
  entryMotion: z.string().describe('Entry animation preset, e.g. "popIn:30:energetic" or "none"'),
  exitMotion: z.string().describe('Exit animation preset, e.g. "slideUp:15:moderate" or "none"'),
});
